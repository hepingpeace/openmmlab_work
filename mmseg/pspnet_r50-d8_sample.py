...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='mmseg/data/Glomeruli-dataset/splits/train.txt'))
val_dataloader = dict(
    batch_size=1,
    num_workers=4,
    persistent_workers=True,
    ...
    dataset=dict(
        ...
        ann_file='mmseg/data/Glomeruli-dataset/splits/val.txt'))
